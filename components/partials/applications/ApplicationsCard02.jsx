        ...
        <div className="grow flex flex-col p-5">
          ...
          <div className="grow">
            ...
            <div className="flex items-center space-x-2 mb-4">
              <div className="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2.5 py-0.5">
                {props.deal}
              </div>
              <div className="inline-flex text-sm font-medium text-slate-500 line-through">
                {props.price}
              </div>
            </div>
          </div>
